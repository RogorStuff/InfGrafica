    ...
    while (sigueRebotando){
        ...
        if (!impactado){    //Si no impacta con nada, termina
            ...
            if (materialFinal->isEmissor()){  //Es una luz, conseguir color y devolver todo
                ...
                Vectores nuevaDir = nuevaDireccion();
...
int main () {
    ...
    Plane plano1(planoCentro1, planoNormal1, color1);//Add material y float nrefractiveinter
    
    Vectores planoCentro2(-4.0, 0.0, 4.0, 1);
    Vectores planoNormal2(1.0, 0.0, 0.0, 0);
    Emission color2(0, 1, 0);
    Plane plano2(planoCentro2, planoNormal2, color2);//Add material y float nrefractiveinter

    Vectores planoCentro3(0.0, 0.0, 8.0, 1);
    Vectores planoNormal3(0.0, 0.0, -1.0, 0);
    Emission color3(1, 1, 1);
    Plane plano3(planoCentro3, planoNormal3, color3);//Add material y float nrefractiveinter

    Vectores planoCentro4(0.0, -4.0, 4.0, 1);
    Vectores planoNormal4(0.0, 1.0, 0.0, 0);
    Emission color4(0, 0, 1);
    Plane plano4(planoCentro4, planoNormal4, color4);//Add material y float nrefractiveinter

    Vectores planoCentro5(0.0, 4.0, 4.0, 1);
    Vectores planoNormal5(0.0, -1.0, 0.0, 0);
    Emission color5(0, 0, 1);
    Plane plano5(planoCentro5, planoNormal5, color5);//Add material y float nrefractiveinter
    
    Vectores bolaAux1(0.0, 0.0, 5.0, 1);
    float radio = 2;
    Emission colorSphere(0.5, 0, 0.5);
    Sphere bola1(bolaAux1,radio,colorSphere);//Add material y float nrefractiveinter
